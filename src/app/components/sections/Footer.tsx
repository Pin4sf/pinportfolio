...
const CTA_TEXT = homepageData.contact.title.toUpperCase();
const MARQUEE_BASE = [
  "Follow",
  "Let\u2019s Connect",
  "Say Hello",
  ...
  return (
    <footer ref={footerRef} className={styles.footer}>
      ...
      <div className={styles.grid}>
        ...
        {/* Status */}
        <div className={`${styles.col} ${styles.reveal}`}>
          <span className={styles.colLabel}>Current work</span>
          <div className={styles.status}>
            <span className={styles.statusDot} />
            <span className={styles.statusText}>{nowSectionData.status}</span>
          </div>
