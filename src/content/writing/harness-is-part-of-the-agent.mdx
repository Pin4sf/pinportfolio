...
> **Note:** I studied more than 40 public agent harnesses through documentation, repositories, product behavior, and architecture notes. This was a design comparison, not a controlled benchmark or 40 production systems I personally operated.

I began the comparison expecting to find a dominant architecture.

I did not.

Coding agents, personal agents, research agents, and workflow systems make very different choices. But the same parts kept appearing: a loop, context, tools, state, permissions, recovery, and some way to decide whether the work was complete.

Those parts often mattered as much as the model.
