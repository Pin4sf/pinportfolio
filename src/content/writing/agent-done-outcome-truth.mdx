...
It can write the file but never publish it. It can open a pull request that never reaches production. It can send a message without resolving the decision behind it.

The transcript looks complete. The original responsibility is still sitting with the person.

That gap is the problem I keep returning to.
